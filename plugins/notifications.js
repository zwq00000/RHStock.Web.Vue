...
//  'error': 'warning',
miniToastr.setIcon('error', 'span', {'class': 'warning'})
miniToastr.setIcon('info', 'span', {'class': 'info'})
miniToastr.setIcon('success', 'span', {'class': 'check_circle'})
miniToastr.setIcon('warning', 'span', {'class': 'priority_high'})
